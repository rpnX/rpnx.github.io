...
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"active-users-container\">{{displayName}}</div>\r\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"messages-box\">\r\n    <app-message *ngFor=\"let message of arrayOfMessages\" [message]=\"message\">\r\n    </app-message>\r\n\r\n</div>\r\n");
...
let ActiveUsersComponent = class ActiveUsersComponent {
...
ActiveUsersComponent.ctorParameters = () => [
    { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] }
];
ActiveUsersComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-active-users',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./active-users.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/active-users/active-users.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./active-users.component.scss */ "./src/app/active-users/active-users.component.scss")).default]
    })
...
/* harmony import */ var _message_sending_message_sending_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./message-sending/message-sending.component */ "./src/app/message-sending/message-sending.component.ts");
/* harmony import */ var _messages_box_messages_box_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./messages-box/messages-box.component */ "./src/app/messages-box/messages-box.component.ts");
...
/* harmony import */ var _active_users_active_users_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./active-users/active-users.component */ "./src/app/active-users/active-users.component.ts");
/* harmony import */ var _message_editing_message_editing_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./message-editing/message-editing.component */ "./src/app/message-editing/message-editing.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _message_sending_message_sending_component__WEBPACK_IMPORTED_MODULE_7__["MessageSendingComponent"],
            _messages_box_messages_box_component__WEBPACK_IMPORTED_MODULE_8__["MessagesBoxComponent"],
            _authentication_authentication_component__WEBPACK_IMPORTED_MODULE_9__["AuthenticationComponent"],
            _message_message_component__WEBPACK_IMPORTED_MODULE_10__["MessageComponent"],
            _active_users_active_users_component__WEBPACK_IMPORTED_MODULE_11__["ActiveUsersComponent"],
            _message_editing_message_editing_component__WEBPACK_IMPORTED_MODULE_12__["MessageEditingComponent"],
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MessageEditingComponent", function() { return MessageEditingComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/auth.service */ "./src/app/services/auth.service.ts");
...
let MessageEditingComponent = class MessageEditingComponent {
    constructor(authService, messagesService) {
        this.authService = authService;
...
MessageEditingComponent.ctorParameters = () => [
    { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
    { type: _services_messages_service__WEBPACK_IMPORTED_MODULE_3__["MessagesService"] }
];
MessageEditingComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-message-editing',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./message-editing.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/message-editing/message-editing.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./message-editing.component.scss */ "./src/app/message-editing/message-editing.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MessageSendingComponent", function() { return MessageSendingComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/auth.service */ "./src/app/services/auth.service.ts");
/* harmony import */ var _services_messages_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/messages.service */ "./src/app/services/messages.service.ts");
...
let MessageSendingComponent = class MessageSendingComponent {
    constructor(authService, messagesService) {
        this.authService = authService;
        this.messagesService = messagesService;
        this.message = '';
...
MessageSendingComponent.ctorParameters = () => [
    { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
    { type: _services_messages_service__WEBPACK_IMPORTED_MODULE_3__["MessagesService"] }
];
MessageSendingComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-message-sending',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./message-sending.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/message-sending/message-sending.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./message-sending.component.scss */ "./src/app/message-sending/message-sending.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".message-container {\n  border-radius: 10px;\n  position: relative;\n  display: -webkit-box;\n  display: flex;\n  min-height: 75px;\n  width: 93%;\n  min-width: 400px;\n  margin-right: 15px;\n  margin-bottom: 15px;\n  margin-top: 15px;\n  margin-left: 30px;\n}\n\n.message-info-container {\n  box-shadow: 0px -1px 10px -2px rgba(0, 0, 0, 0.79);\n  border: 1px solid black;\n  border-radius: 10px;\n  position: absolute;\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n          flex-direction: column;\n  width: 22%;\n  min-height: 75px;\n  overflow: hidden;\n  background-color: #e4e4e4;\n}\n\n.user-displayName {\n  margin-top: 10px;\n  text-align: center;\n  padding: 5px;\n  font-size: 20px;\n  font-weight: 600;\n}\n\n.user-email {\n  text-align: center;\n  color: #364645;\n  font-weight: bold;\n  overflow-wrap: break-word;\n  font-size: 14px;\n}\n\n.time-stamp {\n  position: absolute;\n  bottom: 0;\n  color: #777575;\n  font-size: 12px;\n  right: 25px;\n  margin: 2px;\n}\n\n.message {\n  box-shadow: 0px -2px 19px -2px rgba(0, 0, 0, 0.79);\n  border-radius: 10px;\n  position: relative;\n  overflow-wrap: break-word;\n  min-height: 50px;\n  width: 72%;\n  left: 22.5%;\n  background-color: #ffffff;\n  padding: 10px;\n  padding-right: 20px;\n  padding-bottom: 15px;\n  margin-left: 15px;\n}\n\n.message-container .message-buttons-container {\n  opacity: 0.1;\n  position: absolute;\n  width: 4%;\n  right: 0;\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n          flex-direction: column;\n  justify-content: space-around;\n  -webkit-box-align: center;\n          align-items: center;\n  height: 100%;\n  -webkit-transition: 0.5s;\n  transition: 0.5s;\n}\n\n.message-container .message-buttons-container:hover {\n  opacity: 1;\n  -webkit-transition: 0.5s;\n  transition: 0.5s;\n}\n\n.message-container .message-buttons-container .message-button {\n  height: 23px;\n  width: 23px;\n  margin: 0;\n  padding: 0;\n  border: none;\n  background-size: cover;\n  background-color: transparent;\n  cursor: pointer;\n  outline: none;\n}\n\n.message-container .message-buttons-container .edit-message-button {\n  background-image: url('edit-message.svg');\n}\n\n.message-container .message-buttons-container .remove-message-button {\n  background-image: url('delet-message.svg');\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
MessagesBoxComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./messages-box.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/messages-box/messages-box.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./messages-box.component.scss */ "./src/app/messages-box/messages-box.component.scss")).default]
    })
...
/* harmony import */ var _firebase_firebase__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../firebase/firebase */ "./src/firebase/firebase.js");
...
let AuthService = class AuthService {
    ...
    signInGoogle() {
        _firebase_firebase__WEBPACK_IMPORTED_MODULE_3__["auth"].signInWithPopup(_firebase_firebase__WEBPACK_IMPORTED_MODULE_3__["googleAuthProvider"]).then((result) => {
            const { uid, email, photoURL, displayName } = result.user;
            this.setUser({ uid, email, photoURL, displayName });
        });
    }
    signInFaceBook() {
        _firebase_firebase__WEBPACK_IMPORTED_MODULE_3__["auth"].signInWithPopup(_firebase_firebase__WEBPACK_IMPORTED_MODULE_3__["faceBookAuthProvider"]).then((result) => {
            const { uid } = result.user;
            console.log(uid);
        });
    }
    signOutFaceBook() {
        _firebase_firebase__WEBPACK_IMPORTED_MODULE_3__["auth"].signOut().then(() => { });
    }
    signOutGoogle() {
        _firebase_firebase__WEBPACK_IMPORTED_MODULE_3__["auth"].signOut().then(() => { });
    }
    addAuthStateChangeHandler() {
        _firebase_firebase__WEBPACK_IMPORTED_MODULE_3__["auth"].onAuthStateChanged((result) => {
            if (result) {
...
let MessagesService = class MessagesService {
    ...
    sendMessage(message, email, displayName) {
        _firebase_firebase__WEBPACK_IMPORTED_MODULE_3__["db"].collection('messages').doc().set({ email, message, timeStamp: this.getTimeStamp(), displayName, });
    }
    ...
    editMessage(id, message) {
        _firebase_firebase__WEBPACK_IMPORTED_MODULE_3__["db"].collection('messages').doc(id).update({ message });
    }
    getMessages() {
        _firebase_firebase__WEBPACK_IMPORTED_MODULE_3__["db"].collection('messages').orderBy('timeStamp', 'asc').onSnapshot(querySnapshot => {
            const messages = [];
...
const fb = firebase_app__WEBPACK_IMPORTED_MODULE_0__["database"]();
const db = firebase_app__WEBPACK_IMPORTED_MODULE_0__["firestore"]();
const auth = firebase_app__WEBPACK_IMPORTED_MODULE_0__["auth"]();
const googleAuthProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_0__["auth"].GoogleAuthProvider();
const faceBookAuthProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_0__["auth"].FacebookAuthProvider();
...
module.exports = __webpack_require__(/*! C:\Users\User\Desktop\learn\chat\angular-chat-app\src\main.ts */"./src/main.ts");
